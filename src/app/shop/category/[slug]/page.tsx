...
const categoryProducts: Product[] = [
  {
    ...
    image: '', // e.g., "/products/aparun.jpg"
    type: 'options',
    href: '/shop/aparun',
  },
  {
    id: '2',
    name: 'Deep Clean Tincture',
    price: '₦20,000.00',
    image: '', // e.g., "/products/deep-clean.jpg"
    type: 'cart',
    href: '/shop/deep-clean-tincture',
  },
  {
    id: '3',
    name: 'Jagun Jagun',
    price: '₦25,000.00',
    image: '', // e.g., "/products/jagun-jagun.jpg"
    type: 'cart',
    href: '/shop/jagun-jagun',
  },
  {
    id: '4',
    name: 'Manpower',
    price: '₦5,000.00',
    image: '', // e.g., "/products/manpower.jpg"
    type: 'cart',
    href: '/shop/manpower',
  },
  {
    ...
    name: 'Sleep Aid',
    price: '₦28,000.00',
    image: '', // e.g., "/products/sleep-aid.jpg"
    type: 'cart',
    href: '/shop/sleep-aid',
  },
  {
    ...
    price: '₦35,500.00',
    image: '', // e.g., "/products/tincture-of-life.jpg"
    type: 'cart',
    href: '/shop/tincture-of-life',
  },
  {
    id: '7',
    name: 'Vital Defense',
    price: '₦28,800.00',
    image: '', // e.g., "/products/vital-defense.jpg"
    type: 'cart',
    href: '/shop/vital-defense',
  },
];
...
export default function CategoryPage({
  ...
  // Format category title from slug (e.g., "herbal-tinctures" -> "Herbal Tinctures")
  const categoryTitle = resolvedParams.slug
    ? resolvedParams.slug
        .split('-')
